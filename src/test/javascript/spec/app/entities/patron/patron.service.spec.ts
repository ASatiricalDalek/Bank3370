...
describe('Service Tests', () => {
    describe('Patron Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PatronService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new Patron(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should update a Patron', async () => {
                const returnedFromService = Object.assign(
                    {
                        patronFirstName: 'BBBBBB',
                        patronLastName: 'BBBBBB',
                        patronEmail: 'BBBBBB'
                    },
                    elemDefault
                );
            ...
            it('should return a list of Patron', async () => {
                const returnedFromService = Object.assign(
                    {
                        patronFirstName: 'BBBBBB',
                        patronLastName: 'BBBBBB',
