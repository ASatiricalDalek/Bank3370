...
import com.oustudents.bank3370.repository.BankAccountRepository;
...
public class BankAccountResourceIntTest {
    ...
    private static final Boolean DEFAULT_INSURANCE = false;
    private static final Boolean UPDATED_INSURANCE = true;
    ...
    public void createBankAccount() throws Exception {
        ...
        assertThat(testBankAccount.isInsurance()).isEqualTo(DEFAULT_INSURANCE);
    }
    ...
    @Test
    @Transactional
    public void checkInsuranceIsRequired() throws Exception {
        int databaseSizeBeforeTest = bankAccountRepository.findAll().size();
        // set the field null
        bankAccount.setInsurance(null);
    ...
    public void getAllBankAccounts() throws Exception {
        ...
        restBankAccountMockMvc.perform(get("/api/bank-accounts?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].insurance").value(hasItem(DEFAULT_INSURANCE.booleanValue())));
    }
    ...
    public void getBankAccount() throws Exception {
        ...
        restBankAccountMockMvc.perform(get("/api/bank-accounts/{id}", bankAccount.getId()))
            ...
            .andExpect(jsonPath("$.insurance").value(DEFAULT_INSURANCE.booleanValue()));
    }
    ...
    public void updateBankAccount() throws Exception {
        ...
        assertThat(testBankAccount.isInsurance()).isEqualTo(UPDATED_INSURANCE);
    }
